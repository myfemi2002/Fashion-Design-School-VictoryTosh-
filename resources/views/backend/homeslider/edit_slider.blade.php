            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('slider.update',$editData->id) }}" enctype="multipart/form-data" >
                            @csrf
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group mt-3">
                                        {{-- <label for="exampleInputpwd1">Profile Image</label> --}}
                                        <div class="controls">
                                            <img id="showImage" src="{{ asset($editData->image)}}" style="width: 200px; height:100px; border:1px solid #000000;">
                                        </div>
                                    </div>
