            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('fashionschoolpackages.store') }}" enctype="multipart/form-data" >
                            @csrf
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="fsclass" class="form-control"  placeholder="Class">
