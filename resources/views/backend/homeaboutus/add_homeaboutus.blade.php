...
@section('title', 'Add Home About Us')
@section('admin')
        ...
        <div class="row gutters">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('homeaboutus.store') }}" enctype="multipart/form-data" >
                            @csrf
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="video_link" class="form-control" id="inputEmail4" placeholder="Video Link">
                                    <small class="form-control-feedback">
                                        @error('video_link')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
